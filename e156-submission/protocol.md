...
Protocol: CT.gov Condition Detailed-Description Gap

This protocol isolates missing detailed-description fields inside condition-family CT.gov portfolios. A detailed-description gap is an eligible older closed interventional record missing the detailed description field. Primary outputs rank large condition families by stock and rate using one condition-family label per study.
